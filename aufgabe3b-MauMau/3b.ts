window.onload = function (): void {
    ...
    let deck: string[] = ["Herz 7", "Herz 8", "Herz 9", "Herz 10", "Herz Bube", "Herz Dame", "Herz King", "Herz Ass", "Pik 7", "Pik 8", "Pik 9", "Pik 10", "Pik Bube", "Pik Dame", "Pik King", "Pik Ass", "Karo 7", "Karo 8", "Karo 9", "Karo 10", "Karo Bube", "Karo Dame", "Karo König", "Karo Ass", "Kreuz 7", "Kreuz 8", "Kreuz 9", "Kreuz 10", "Kreuz Bube", "Kreuz Dame", "Kreuz King", "Kreuz Ass"];
    let discard: string[] = [] ;
    let hand: string[] = [] ;
...
//createDiv           
    ...
    function pullCard(): void {
        ...
        //randomCard
        let randomCard: number = Math.floor((Math.random() * 31 - 1));
