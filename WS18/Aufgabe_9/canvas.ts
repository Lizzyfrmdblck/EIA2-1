namespace A9 {
    ...
    function init(_event: Event): void {
        ...
        for (let i: number = 0; i < 50; i++) {
            //RND   NUMS TREE POS
            let randX: number = (Math.random() * (400 - 15) + 0);
            let randY: number = (Math.random() * (500 - 200) + 400);
    ...
    //SLEDGE
    function drawSledge(_x: number): void {
    ...
    //SNOWFLAKE
    function drawFlake(_x: number, _y: number, size: number): void {
        crc2.beginPath();
