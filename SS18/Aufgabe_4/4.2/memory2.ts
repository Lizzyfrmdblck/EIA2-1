namespace Aufgabe_2 {
    ...
    function init(): void {
        ...
        //addPlayerButton();
        let addPlayerButton: HTMLButtonElement = <HTMLButtonElement>document.getElementById("addPlayerButton");
        addPlayerButton.addEventListener("click", addPlayer);
        //removePlayer
        let removePlayerButton: HTMLButtonElement = <HTMLButtonElement>document.getElementById("removePlayerButton");
   ...
   //     document.getElementById("playernames").classList.add("taken");
    ...
    function removePlayer(): void {
        let inputs: NodeListOf<HTMLInputElement> = document.getElementsByTagName("input");
        let fieldset: HTMLElement = document.getElementById("interface");
        console.log(fieldset);
        
        //gefühlt alle Varianten probiert, aber komme nicht an das letzte Input/Child vom ersten Fieldset ran
...
/*    do  {
   ...
   Nach der String-Test kann ich aber auch Zahlen außerhalb der Range eingeben und er springt weiter. 
